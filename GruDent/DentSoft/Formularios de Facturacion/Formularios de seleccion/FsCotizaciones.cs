...
{
    public partial class FSCotizaciones : Form
    {
        public FSCotizaciones()
        {
            InitializeComponent();
        }
        ...
        private void dgvProceConsulta_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                cot.lblproceso.Text = dgvProceConsulta.CurrentRow.Cells["Nombre"].Value.ToString();
                cot.lblcosto.Text = dgvProceConsulta.CurrentRow.Cells["Costo"].Value.ToString();
